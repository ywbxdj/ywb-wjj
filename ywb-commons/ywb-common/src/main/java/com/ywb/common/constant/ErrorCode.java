package com.ywb.common.constant;
...
public interface ErrorCode {
    enum Common implements IMessage {
         ...
         * 权限模块-账号或密码输入有误！
         */
        userPwdNotMatch(1037),
        /**
         * 没有配置bean SessionUtil
         */
        onMissingBean(1037);
    ...
    enum Login implements IMessage {
        /**
         * 验证码不存在或已过期
         */
        vilidateCodeTimeout(3001),
        /**
         * 验证码错误
         */
        errorVilidateCode(3002);
