package com.ywb.common.repository.impl;

import com.ywb.common.model.BaseModel;
import com.ywb.common.query.DynamicSpecifications;
import com.ywb.common.query.SearchFilter;
import com.ywb.common.repository.BaseJpaRepository;
import com.ywb.common.util.BeanUtils;
 ...
 * @param <ID> id
 */
public class BaseJpaRepositoryImpl<T extends BaseModel, ID extends Serializable> extends SimpleJpaRepository<T, ID> implements BaseJpaRepository<T, ID> {
	...
	public <S extends T> T updateById(S param) {
		ID id = (ID) param.getId();
		T entity = findOne(id);
		Optional.ofNullable(entity).ifPresent(t -> {
			BeanUtils.copyNotNullProperties(param, t);
		});
